...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Made Captain Results Page</title>
            ...
            <div class="row">
                <div class="row">
                    ...
                    <div class="col-8">
                        <?php
                        $pos = 0;
                        print("<p class='title'>Captain $CapName at the age of $CapAge "
                                . "took over the ship $ShipName and here is some of their past.</p>");
                        $EarlyFile = fopen("EarlyYears.txt", "r") or die("Unable to read file!");
